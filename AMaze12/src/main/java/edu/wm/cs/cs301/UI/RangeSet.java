...
public class RangeSet implements Serializable{
     ...
     * @param coordinates describes interval [p.x,p.y], its entries are modified to represent the intersection if there is one
     * @return true if there is an intersection, false otherwise
     */
    public boolean intersect(int[] coordinates) {
